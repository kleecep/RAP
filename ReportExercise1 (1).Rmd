...
We loaded the data set and compiled the report on `r Sys.Date()`
...
The variable *Principle_Exports* lists all the types of goods exported from Vanuatu. There are **`r length(unique(TradeData$Principle_Exports))`** different goods exported. Let's have the list of all these goods.
